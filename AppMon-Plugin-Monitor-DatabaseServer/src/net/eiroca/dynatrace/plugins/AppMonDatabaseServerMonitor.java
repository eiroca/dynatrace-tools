...
public class AppMonDatabaseServerMonitor extends AppMonPluginMonitor {

  static {
    AppMonPluginMonitor.name = "Database Monitor";
    AppMonPluginMonitor.monitorClass = DatabaseMonitor.class;
  }
